let theInput = (document.getElementById("input").oninput = function () {
  ...
  if (isNaN(this.value)) {
    result.textContent = ` متبطل 💩 💩 💩  بقا وتكتب رقم`;
...
document.getElementById('vid').pause();
 ...
 document.getElementById('vid3').currentTime = 0;
  ...
  if ((this.value >=1000000) && (this.value < 9000000)) {
    result.textContent = ` طبعا بتجرب رقم معدى المليون علشان تعيش حياة المليونيرات وإنت بتشرب الشاي في العيد بس مش هكسفك وهيتشحن ب ${theResult}  جنيه    `;
...
{
        result.textContent = `هتجيب  منين فلوس علشان تشحن رصيد ب ${theResult}  جنيه `;
 ...
 document.getElementById('vid4').currentTime = 0;
    ...
    if  ((this.value >=100000) && (this.value < 999999))
{
    ...
    if  ((this.value >=100001) && (this.value < 1000000))
{
    ...
    document.getElementById('vid4').play();
       ...
       document.getElementById('vid4').style.visibility = "visible";
 document.getElementById('vid1').pause();
           document.getElementById('vid1').style.visibility = "hidden";
 ...
 document.getElementById('vid5').currentTime = 0;
  ...
  if ((this.value >=9000001) && (this.value < 200000000)) {
    result.textContent = ` 🙉🙈  🙈  إنت روش بقي ومحرمتش لأ ده انت تاخد رقمى بقا`;
      
  document.getElementById('vid5').style.visibility = "visible";
